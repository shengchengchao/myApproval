 ...
 */
@Component
public class ParallelNodeProcess extends AbstractNodeProcess {
    /**
     * 审批
     *
    ...
    protected AbstractNode getNode(ApprovalConfigEntity approvalConfigEntity, ApprovalLogEntity approvalLogEntity) {
        ...
        ParallelNode parallelNode = new ParallelNode(Arrays.asList(split), approvalConfigEntity.getNodeType(),
